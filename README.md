...
| **`geomstats`** | Provides **Riemannian metric tensor** operations ($g_{ij}$), geodesic equations, and manifold geometry routines for validation and high-level metric computations.                                                                                       |
