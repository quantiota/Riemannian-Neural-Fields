...
| **`torchmanifolds`** | Provides **PyTorch-native Riemannian manifold support**, including metric-aware operations, geodesic updates, and curvature-consistent tensor computations integrated directly into the learning loop.                                                    
...
### Status
- **Phase 1:** Theoretical formulation [(completed)](https://github.com/quantiota/SKA-Riemannian-Neural-Fields/tree/main/foundational_papers) 
- **Phase 2:** 3D/4D prototype simulations (in progress) 
- **Phase 3**  Framework validation with [Universal Language Manifold](https://github.com/quantiota/Universal-Language-Manifold) (planned for 2026)
