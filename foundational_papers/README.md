...
$$
\large L(z, \dot{z}) = -z \, \sigma(z)(1 - \sigma(z)) \dot{z}
$$

The Euler–Lagrange equation,

$$
\large \frac{d}{dt}\left(\frac{\partial L}{\partial \dot{z}}\right) - \frac{\partial L}{\partial z} = 0,
$$
...
$$
\large H \Rightarrow L \Rightarrow g_{ij}
$$
